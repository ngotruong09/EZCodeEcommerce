...
namespace EZCode.CustomerService.Web.Menus;

public class CustomerServiceMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public CustomerServiceMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<CustomerServiceResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                CustomerServiceMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
